                            ...
                            <div class="widget">
                                ...
                                <ul class="sidebar__contact__info">
                                    ...
                                    <li class="cagegory"><span>Category :</span>
                                        <a href="{{ url("portfolio.html") }}">Photo,</a>
                                        <a href="{{ url("portfolio.html") }}">UI/UX</a>
                                    </li>
                                    <li><span>Project Link :</span> <a href="{{ url("portfolio-details.html") }}">https://www.yournews.com/</a></li>
                                </ul>
                            </div>
                            <div class="widget">
                                ...
                                <ul class="sidebar__contact__social">
                                    <li><a href="{{ url("#") }}"><i class="fab fa-dribbble"></i></a></li>
