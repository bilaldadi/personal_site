            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="banner__content">
                        ...
                        <a href="{{ url("about.html") }}" class="btn banner__btn wow fadeInUp" data-wow-delay=".6s">more about me</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="scroll__down">
            <a href="{{ url("#aboutSection") }}" class="scroll__link">Scroll down</a>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <a href="{{ url("about.html") }}" class="btn">Download my resume</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row gx-0 services__active">
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="{{ url("services-details.html") }}"><img src="{{ asset("/frontend/assets/img/images/services_img01.jpg") }}" alt=""></a>
                        </div>
                        <div class="services__content">
                            ...
                            <h3 class="title"><a href="{{ url("services-details.html") }}">Business Strategy</a></h3>
                            ...
                            <a href="{{ url("services-details.html") }}" class="btn border-btn">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="{{ url("services-details.html") }}"><img src="{{ asset("/frontend/assets/img/images/services_img02.jpg") }}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                            ...
                            <h3 class="title"><a href="{{ url("services-details.html") }}">Brand Strategy</a></h3>
                            <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
                            <ul class="services__list">
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="{{ url("services-details.html") }}"><img src="{{ asset("/frontend/assets/img/images/services_img03.jpg") }}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                            ...
                            <h3 class="title"><a href="{{ url("services-details.html") }}">Product Design</a></h3>
                            <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
                            <ul class="services__list">
                                <li>User Research & Testing</li>
                                <li>UX Design</li>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="{{ url("services-details.html") }}"><img src="{{ asset("/frontend/assets/img/images/services_img04.jpg") }}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                            ...
                            <h3 class="title"><a href="{{ url("services-details.html") }}">Visual Design</a></h3>
                            <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
                            <ul class="services__list">
                                <li>User Research & Testing</li>
                                <li>UX Design</li>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            ...
                            <h3 class="title"><a href="{{ url("services-details.html") }}">Web Development</a></h3>
                            <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
                            <ul class="services__list">
                                <li>User Research & Testing</li>
                                <li>UX Design</li>
                            ...
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        ...
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Banking Management System</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Nature of Business Strategy System</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Product Design and Development</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Brand strategy System Management</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Visual Design System Management</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>UX/UI Design</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Animation Management System</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        <span>Web Design</span>
                                        <h4 class="title"><a href="{{ url("portfolio-details.html") }}">Graphic Design Management System</a></h4>
                                        <a href="{{ url("portfolio-details.html") }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                <div class="portfolio__item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="partner__content">
                        ...
                        <a href="{{ url("contact.html") }}" class="btn">Start a conversation</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            <a href="{{ url("blog-details.html") }}"><img src="{{ asset("/frontend/assets/img/blog/blog_post_thumb01.jpg") }}" alt=""></a>
                            <div class="blog__post__tags">
                                <a href="{{ url("blog.html") }}">Story</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">13 january 2021</span>
                            <h3 class="title"><a href="{{ url("blog-details.html") }}">Facebook design is dedicated to what's new in design</a></h3>
                            <a href="{{ url("blog-details.html") }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            <a href="{{ url("blog-details.html") }}"><img src="{{ asset("/frontend/assets/img/blog/blog_post_thumb02.jpg") }}" alt=""></a>
                            <div class="blog__post__tags">
                                <a href="{{ url("blog.html") }}">Social</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">13 january 2021</span>
                            <h3 class="title"><a href="{{ url("blog-details.html") }}">Make communication Fast and Effectively.</a></h3>
                            <a href="{{ url("blog-details.html") }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            <a href="{{ url("blog-details.html") }}"><img src="{{ asset("/frontend/assets/img/blog/blog_post_thumb03.jpg") }}" alt=""></a>
                            <div class="blog__post__tags">
                                <a href="{{ url("blog.html") }}">Work</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">13 january 2021</span>
                            <h3 class="title"><a href="{{ url("blog-details.html") }}">How to increase your productivity at work - 2021</a></h3>
                            <a href="{{ url("blog-details.html") }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="blog__button text-center">
                <a href="{{ url("blog.html") }}" class="btn">more blog</a>
            </div>
        </div>
    </section>
    <!-- blog-area-end -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="homeContact__content">
                            ...
                            <h2 class="mail"><a href="{{ url("mailto:Info@webmail.com") }}">Info@webmail.com</a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
